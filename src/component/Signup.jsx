...
const Signup = ()=>{
    ...
    return(
        <>
            <div class="mh-100  col-7 mt-5 d-inline-block ">
                
                <div  class="container col-4 mt--1  mb-1">
                    <h3> Sign Up</h3>
                    ...
                    <input type="text" id="email" ref={email} class="form-control" placeholder="Enter Email Address" aria-label="Username" aria-describedby="basic-addon1" /><br></br>
